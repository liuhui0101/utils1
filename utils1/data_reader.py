...
if __name__ == '__main__':
    lines = read_data('/Users/chenlu/Desktop/dataset/train_set.seg_x.txt'.format(BASE_DIR),
    ...
    save_word_dict(vocab, '/Users/chenlu/Desktop/dataset/vocab.txt'.format(BASE_DIR))