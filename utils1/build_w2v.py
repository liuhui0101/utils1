...
def build(train_x_seg_path, test_y_seg_path, test_seg_path, out_path=None, sentence_path='',
    ...
    w2v = （one line）
    """
    w2v = Word2Vec(sentences, size=50)
    w2v.wv.save_word2vec_format(w2v_bin_path, binary=True)
    print("save %s ok." % w2v_bin_path)
    # test
    sim = w2v.wv.similarity('你', '我')
    print('你 vs 我 similarity score:', sim)
    # load model
...
if __name__ == '__main__':
    build('/Users/chenlu/Desktop/dataset/train_set.seg_x.txt'.format(BASE_DIR),
          '/Users/chenlu/Desktop/dataset/train_set.seg_y.txt'.format(BASE_DIR),
          '/Users/chenlu/Desktop/dataset/test_set.seg_x.txt'.format(BASE_DIR),
          out_path='/Users/chenlu/Desktop/dataset//word2vec.txt'.format(BASE_DIR),
          sentence_path='/Users/chenlu/Desktop/dataset/sentences.txt'.format(BASE_DIR))
