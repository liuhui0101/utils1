...
def parse_data(train_path, test_path):
    ...
    test_y = []
    train_x.to_csv('/Users/chenlu/Desktop/dataset/train_set.seg_x.txt'.format(BASE_DIR), index=None, header=False)
    train_y.to_csv('/Users/chenlu/Desktop/dataset/train_set.seg_y.txt'.format(BASE_DIR), index=None, header=False)
    test_x.to_csv('/Users/chenlu/Desktop/dataset/test_set.seg_x.txt'.format(BASE_DIR), index=None, header=False)
...
if __name__ == '__main__':
    # 需要更换成自己数据的存储地址
    parse_data('/Users/chenlu/Desktop/dataset/AutoMaster_TrainSet.csv'.format(BASE_DIR),
               '/Users/chenlu/Desktop/dataset/AutoMaster_TestSet.csv'.format(BASE_DIR))
